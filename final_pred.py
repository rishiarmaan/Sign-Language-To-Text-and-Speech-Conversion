...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x=50, y=100, width=640, height=480)

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=750, y=115, width=400, height=400)

        self.T = tk.Label(self.root)
        self.T.place(x=60, y=15)
        self.T.config(text="Sign Language To Text Conversion", font=("Courier", 30, "bold"))

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=280, y=595)
        ...
        self.panel5.place(x=260, y=642)

        self.T3 = tk.Label(self.root)
        self.T3.place(x=10, y=642)
        self.T3.config(text="Sentence :", font=("Courier", 30, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=710)
                ...
                if hands:
                    ...
                    if image is not None and image.size != 0:
                        ...
                        if handz:
                            ...
                            for i in range(21):
                                cv2.circle(white, (self.pts[i][0] + os, self.pts[i][1] + os1), 2, (0, 255, 0), 1)
